...
boolean cur_sand_direction;
boolean init_sand_direction = true;
...
cur_sand_direction = init_sand_direction;

if(cur_sand_direction){
      ...
      if (mode == 1){ //reaching needed rpm        
         ...
         if (millis() < start_time_ms + term_ms){
             ...
             if( /*int(millis())*/i % ratio == 0 ){
                 ...
                 if(r_sensor_state == HIGH || l_sensor_state == HIGH){cur_sand_direction = !cur_sand_direction;}
